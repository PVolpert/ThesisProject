...
func LoadAppConfigurationFromEnv() (AppConfiguration, error) {
	...
	signingAlgorithmString := env.Get("ALG", "ES256")
	...
	defaultTokenPeriodString := env.Get("DEFAULT_TOKEN_PERIOD", "3600")
	...
	maxTokenPeriodString := env.Get("MAX_TOKEN_PERIOD", "2592000")

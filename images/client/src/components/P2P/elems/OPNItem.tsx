...
export default function OPNItem({
    ...
    return (
        <div
            key={ictProviderName}
            className="bg-zinc-100 dark:bg-zinc-600 border-zinc-500"
        >
            <input
                type="checkbox"
                id={ictProviderName}
            ...
            <label htmlFor={ictProviderName}>
                <div
                    className={`flex items-center justify-center w-full p-2 space-x-3  border rounded shadow-sm hover:brightness-110 hover:shadow-lg hover:-translate-y-0.5 transition duration-1050 ${
                        checked

...
export default function UserItem({ username, callFct }: UserItemProps) {
    return (
        <li className="first:rounded-t-lg last:rounded-b-lg flex space-x-3 justify-around content-center p-2 bg-zinc-300 dark:bg-zinc-700  hover:brightness-110 hover:-translate-y-0.5 transition duration-1050">
